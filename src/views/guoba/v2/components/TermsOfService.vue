<template>
  <div class="terms-box">
    ...
    <p> 你好！由于V2版本云崽已经停止维护，故锅巴插件经过深思熟虑后，决定将不会支持V2版本的云崽，但会增加“迁移”功能，欢迎使用！ </p>
    <h3> 一、迁移功能介绍</h3>
    <p>“迁移”包含以下功能：</p>
    <ol>
    ...
    <h3>二、迁移功能免责声明</h3>
    <p> 在正式发布前，“迁移”功能已经测试过数次，且本人也是通过该功能升级的V3，目前没有发现问题，请放心使用。以下条款仅仅是防止有人恶意利用该功能搞事的。 </p>
    <ol>
      <li> 锅巴只提供方便的图形化操作界面和配置迁移的补充，实际上云崽本身就提供了老版本的兼容升级功能。 </li>
      <li>
