<template>
  <div>
    ...
    <SelectGroupModal :rowKey="rowKey" @register="registerModal" @getSelectResult="setValue" v-bind="getBindValue" />
  </div>
</template>
<script lang="ts">
  ...
  export default defineComponent({
    ...
    components: {
      GSelectBiz,
      SelectGroupModal: createAsyncComponent(() => import('./modal/SelectGroupModal.vue')),
    },
    props: {
      value: propTypes.array,
      rowKey: propTypes.string.def('group_id'),
      labelKey: propTypes.string.def('group_name'),
