...
<script lang="tsx">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const [{ rowSelection, visibleChange, selectValues, indexColumnProps, getSelectResult, handleDeleteSelected, selectRows }] = useSelectModal(getFriendList, getBindValue);
